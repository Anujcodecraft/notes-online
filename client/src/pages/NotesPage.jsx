        ...
        <>
                  ...
                  <div className="p-6">
                    ...
                    <div className="mt-6">
                      <button
                        ...
                        className="w-full flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-gradient-to-r from-cyan-500 to-cyan-700 hover:to-blue-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                      >
                        View PDF
                      </button>
                    </div>
          ...
          <div className="flex justify-between items-center mt-8">
            <button
              ...
              disabled={page === 0}
              className={`px-4 py-2 rounded-md ${page === 0 ? 'bg-gray-300 cursor-not-allowed' : 'bg-cyan-600 hover:bg-cyan-700 text-white'}`}
            >
              Previous
            </button>
            ...
            <button
              ...
              disabled={!hasMore}
              className={`px-4 py-2 rounded-md ${!hasMore ? 'bg-gray-300 cursor-not-allowed' : 'bg-cyan-600 hover:bg-cyan-700 text-white'}`}
            >
              Next
            </button>
          </div>
