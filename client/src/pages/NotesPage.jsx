...
const NotesPage = () => {
  ...
  const renderNotesContent = () => {
    ...
    if (error) {
      return (
        <div className="bg-red-50 dark:bg-red-200/10 border-l-4 border-red-400 dark:border-red-600 p-4 mb-6 rounded">
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg mb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div>
              ...
              <select
                className="block w-full pl-3 pr-10 py-2 text-base border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-md"
                id="year"
                name="year"
                value={filters.year}
            ...
            {/* Branch and Subject Filters – same style */}
            {/* Add same dark: classes as above on selects and labels */}
          </div>
        </div>
