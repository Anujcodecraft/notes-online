...
const UploadNotesPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        `${import.meta.env.VITE_BASE_URL_BACKEND}/upload-notes`,
        {
          method: "POST",
          headers: {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
        ...
        <form onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <select
                className="appearance-none border rounded w-full py-2 px-3 bg-white dark:bg-gray-700 text-gray-700 dark:text-white leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500"
                id="year"
                name="year"
                value={formData.year}
            ...
            <div>
              ...
              <input
                className="appearance-none border rounded w-full py-2 px-3 bg-white dark:bg-gray-700 text-gray-700 dark:text-white leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500 file:mr-3 file:py-1 file:px-2 file:border-0 file:bg-blue-600 file:text-white file:rounded hover:file:bg-blue-700"
                id="file"
                name="file"
                type="file"
          ...
          <div className="mt-6">
            <button
              className="bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 text-white font-bold py-2 px-4 rounded w-full focus:outline-none focus:ring-2 focus:ring-blue-300"
              type="submit"
              disabled={loading}
            >
      ...
      {/* Note Section */}
      <div className="mt-6 p-4 bg-yellow-100 dark:bg-yellow-900 border-l-4 border-yellow-500 dark:border-yellow-400 text-yellow-700 dark:text-yellow-300 rounded">
