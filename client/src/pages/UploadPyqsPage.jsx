  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        `${import.meta.env.VITE_BASE_URL_BACKEND}/upload-pyqs`,
        {
          method: "POST",
          headers: {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
        {error && (
          <div className="bg-red-100 dark:bg-red-200 border border-red-400 text-red-700 dark:text-red-900 px-4 py-3 rounded mb-4">
            {error}
          </div>
        )}
        ...
        <form onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <select
                className="appearance-none border rounded w-full py-2 px-3 text-gray-700 dark:text-white bg-white dark:bg-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-green-500"
                id="year"
                name="year"
                value={formData.year}
          ...
          <div className="mt-6">
            <button
              className="bg-green-600 hover:bg-green-700 dark:bg-green-500 dark:hover:bg-green-600 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline w-full"
              type="submit"
              disabled={loading}
            >
      ...
      <div className="mt-6 p-4 bg-yellow-100 dark:bg-yellow-200 border-l-4 border-yellow-500 text-yellow-700 dark:text-yellow-900">
