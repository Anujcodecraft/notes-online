...
export default function UserPagePreview() {
    ...
    const fetchUserStats = async () => {
      ...
      try {
        ...
        const pyqsRes = await axios.get(
          `${import.meta.env.VITE_BASE_URL_BACKEND}/my-pyqs?email=${
            currentUser.emailtoSend
          }`
        );
  ...
  const statCards = [
    ...
    {
      icon: FileText,
      value: stats.pyqsUploaded,
      label: "PYQs",
      color: "green",
    },
    {
      icon: CheckSquare,
      value: stats.solutionsUploaded,
      label: "Solutions",
      color: "purple",
    },
    {
      icon: Clock,
      value: new Date(stats.dateJoined).toLocaleDateString(),
      label: "Member Since",
      color: "indigo",
    },
  ];
  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center h-[calc(100vh-1px)] pt-24 bg-gradient-to-br from-gray-50 to-gray-100">
        ...
        >
          ...
          <div className="bg-gradient-to-r from-blue-600 to-blue-500 px-16 py-16 relative">
            <div className="flex flex-col items-center">
              ...
              <p className="text-blue-100 mt-2">{currentUser.emailtoSend}</p>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="grid grid-cols-2 gap-8">
                {statCards.map((stat, index) => (
                  ...
                  >
                    <div
                      className={`p-3 rounded-full bg-${stat.color}-100 dark:bg-${stat.color}-900/50 mb-3`}
                    >
                      <stat.icon
